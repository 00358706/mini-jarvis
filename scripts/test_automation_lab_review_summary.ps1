...
try {
    ...
    Assert-True ($summaryText -match "source=.*fixture:") "Review summary should record fixture id in combined source string."
    Assert-True ($summaryText -match "registry_read=true") "Review summary should report registry read true."
